...
async function checkRepoUpdates() {
  if (isError) return;
  try {
    const response = await axios.get(`https://api.github.com/repos/Ochoa21/api/commits?per_page=1`);
...
app.listen(PORT, function() {
    ...
    const creatorMessage = chalk.magenta.bold('| Creador: Ochoa');
    const numberMessage = chalk.magenta.bold('| Numero: +57 314 622 4366');
